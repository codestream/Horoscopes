...
public class CancerWeekActivity extends BaseActivity implements HoroscopeClipboard {
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.layout_cancer_week);
        AsyncTask<Void,Integer,String> asyncTask = new AsyncCancerWeekHoroscope(this);
        asyncTask.execute();
    }
    ...
    protected void saveCurrentHoroscope(){
        saveCancerWeekHoroscope();
    }

    private void saveCancerWeekHoroscope() {
        HoroscopeDatabase horoscopeDatabase = new HoroscopeDatabase(CancerWeekActivity.this);
        SQLiteDatabase sqLiteDatabase = horoscopeDatabase.getWritableDatabase();
        TextView textView = (TextView)findViewById(R.id.tvCancerWeek);
    ...
    private class AsyncCancerWeekHoroscope extends AsyncTask<Void,Integer,String> {
        private Context mContext;
        private ProgressDialog mDialog;

        public AsyncCancerWeekHoroscope(Context context){
        ...
        protected String doInBackground(Void... voids) {
            final String url = "http://goroskop.online.ua/cancer/week";
            String result = "";
            try {
