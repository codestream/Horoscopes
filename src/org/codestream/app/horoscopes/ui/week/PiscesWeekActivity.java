...
public class PiscesWeekActivity extends BaseActivity implements HoroscopeClipboard {
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.layout_pisces_week);
        AsyncTask<Void,Integer,String> asyncTask = new AsyncPiscesWeekHoroscope(this);
        asyncTask.execute();
    }
    ...
    protected void saveCurrentHoroscope(){
        HoroscopeDatabase horoscopeDatabase = new HoroscopeDatabase(PiscesWeekActivity.this);
        SQLiteDatabase sqLiteDatabase = horoscopeDatabase.getWritableDatabase();
        TextView textView = (TextView)findViewById(R.id.tvPiscesWeek);
    ...
    private class AsyncPiscesWeekHoroscope extends AsyncTask<Void,Integer,String> {
        private Context mContext;
        private ProgressDialog mDialog;

        public AsyncPiscesWeekHoroscope(Context context){
        ...
        protected String doInBackground(Void... voids) {
            final String url = "http://goroskop.online.ua/pisces/week";
            String result = "";
            try {
        ...
        protected void onPostExecute(String result) {
            ...
            if(mDialog.isShowing()){
                mDialog.dismiss();
                //TODO: make refactoring of all project
                //TODO: change base class for activities to base activity
            }
        }
    }
}