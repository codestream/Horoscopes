...
public class AriesWeekActivity extends BaseActivity implements HoroscopeClipboard {
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.layout_aries_week);
        AsyncTask<Void,Integer,String> asyncTask = new AsyncAriesWeekHoroscope(this);
        asyncTask.execute();
    }
    ...
    protected void saveCurrentHoroscope(){
        saveAriesWeekHoroscope();
    }

    private void saveAriesWeekHoroscope() {
    ...
    private class AsyncAriesWeekHoroscope extends AsyncTask<Void,Integer,String> {
        ...
        public AsyncAriesWeekHoroscope(Context context){
