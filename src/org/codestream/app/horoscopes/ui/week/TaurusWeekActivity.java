...
public class TaurusWeekActivity extends BaseActivity implements HoroscopeClipboard {
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.layout_taurus_week);
        AsyncTask<Void,Integer,String> asyncTask = new AsyncTaurusWeekHoroscope(this);
        asyncTask.execute();
    }
    ...
    protected void saveCurrentHoroscope(){
        HoroscopeDatabase horoscopeDatabase = new HoroscopeDatabase(TaurusWeekActivity.this);
        SQLiteDatabase sqLiteDatabase = horoscopeDatabase.getWritableDatabase();
        TextView textView = (TextView)findViewById(R.id.tvTaurusWeek);
    ...
    private class AsyncTaurusWeekHoroscope extends AsyncTask<Void,Integer,String> {
        private Context mContext;
        private ProgressDialog mDialog;

        public AsyncTaurusWeekHoroscope(Context context){
        ...
        protected String doInBackground(Void... voids) {
            final String url = "http://goroskop.online.ua/taurus/week";
            String result = "";
            try {
