...
public class CapricornWeekActivity extends BaseActivity implements HoroscopeClipboard {
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.layout_capricorn_week);
        AsyncTask<Void,Integer,String> asyncTask = new AsyncCapricornWeekHoroscope(this);
        asyncTask.execute();
    }
    ...
    protected void saveCurrentHoroscope(){
        HoroscopeDatabase horoscopeDatabase = new HoroscopeDatabase(CapricornWeekActivity.this);
        SQLiteDatabase sqLiteDatabase = horoscopeDatabase.getWritableDatabase();
        TextView textView = (TextView)findViewById(R.id.tvCapricornWeek);
    ...
    private class AsyncCapricornWeekHoroscope extends AsyncTask<Void,Integer,String> {
        private Context mContext;
        private ProgressDialog mDialog;
        private static final String TAG = "AsyncCapricornHoroscope";

        public AsyncCapricornWeekHoroscope(Context context){
        ...
        protected String doInBackground(Void... voids) {
            final String url = "http://goroskop.online.ua/capricorn/week";
            String result = "";
            try {
