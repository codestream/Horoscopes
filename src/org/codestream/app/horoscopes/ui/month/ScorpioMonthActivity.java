...
public class ScorpioMonthActivity extends BaseActivity implements HoroscopeClipboard {
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.layout_scorpio_month);
        AsyncTask<Void,Integer,String> asyncTask = new AsyncScorpioMonthHoroscope(this);
        asyncTask.execute();
    }
    ...
    protected void saveCurrentHoroscope(){
        HoroscopeDatabase horoscopeDatabase = new HoroscopeDatabase(ScorpioMonthActivity.this);
        SQLiteDatabase sqLiteDatabase = horoscopeDatabase.getWritableDatabase();
        TextView textView = (TextView)findViewById(R.id.tvScorpioMonth);
    ...
    private class AsyncScorpioMonthHoroscope extends AsyncTask<Void,Integer,String> {
        private Context mContext;
        private ProgressDialog mDialog;

        public AsyncScorpioMonthHoroscope(Context context){
        ...
        private static final String TAG = "AsyncScorpioMonthHoroscope";
        @Override
        protected String doInBackground(Void... voids) {
            final String url = "http://goroskop.online.ua/scorpio/month";
            String result = "";
            try {
