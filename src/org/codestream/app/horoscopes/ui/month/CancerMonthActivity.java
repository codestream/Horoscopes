...
public class CancerMonthActivity extends BaseActivity implements HoroscopeClipboard {
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.layout_cancer_month);
        AsyncTask<Void,Integer,String> asyncTask = new AsyncCancerMonthHoroscope(this);
        asyncTask.execute();
    }
    ...
    protected void saveCurrentHoroscope(){
        HoroscopeDatabase horoscopeDatabase = new HoroscopeDatabase(CancerMonthActivity.this);
        SQLiteDatabase sqLiteDatabase = horoscopeDatabase.getWritableDatabase();
        TextView textView = (TextView)findViewById(R.id.tvCancerMonth);
    ...
    private class AsyncCancerMonthHoroscope extends AsyncTask<Void,Integer,String> {
        private Context mContext;
        private ProgressDialog mDialog;

        public AsyncCancerMonthHoroscope(Context context){
        ...
        private static final String TAG = "AsyncCancerMonthHoroscope";
        @Override
        protected String doInBackground(Void... voids) {
            final String url = "http://goroskop.online.ua/cancer/month";
            String result = "";
            try {
