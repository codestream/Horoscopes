...
public class SagittariusMonthActivity extends BaseActivity implements HoroscopeClipboard {
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.layout_sagittarius_month);
        AsyncTask<Void,Integer,String> asyncTask = new AsyncSagittariusMonthHoroscope(this);
        asyncTask.execute();
    }
    ...
    private class AsyncSagittariusMonthHoroscope extends AsyncTask<Void,Integer,String> {
        ...
        public AsyncSagittariusMonthHoroscope(Context context){
