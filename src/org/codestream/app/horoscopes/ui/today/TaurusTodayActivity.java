...
public class TaurusTodayActivity extends BaseActivity implements HoroscopeClipboard {
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.layout_taurus_today);
        AsyncTask<Void,Integer,String> asyncTask = new AsyncTaurusHoroscope(this);
        asyncTask.execute();
    }
    ...
    */
    ...
    private class AsyncTaurusHoroscope extends AsyncTask<Void,Integer,String> {
        ...
        public AsyncTaurusHoroscope(Context context){
