...
public class AriesYearActivity extends BaseActivity implements HoroscopeClipboard {
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.layout_aries_year);
        AsyncTask<Void,Integer,String> asyncTask = new AsyncAriesYearHoroscope(this);
        asyncTask.execute();
    }
    ...
    public void copyHoroscopeToClipboard() {
        TextView textView = (TextView)findViewById(R.id.tvAriesYear);
    ...
    protected void saveCurrentHoroscope(){
        HoroscopeDatabase horoscopeDatabase = new HoroscopeDatabase(AriesYearActivity.this);
    ...
    private class AsyncAriesYearHoroscope extends AsyncTask<Void,Integer,String> {
        private Context mContext;
        private ProgressDialog mProgressDialog;

        public AsyncAriesYearHoroscope(Context context){
        ...
        private static final String TAG = "AsyncAriesYearHoroscope";
        @Override
        protected String doInBackground(Void... voids) {
            final String url = "http://goroskop.online.ua/aries/year";
            String result = "";
            try {
