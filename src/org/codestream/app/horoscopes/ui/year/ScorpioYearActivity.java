...
public class ScorpioYearActivity extends BaseActivity implements HoroscopeClipboard {
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.layout_scorpio_year);
        AsyncTask<Void,Integer,String> asyncTask = new AsyncScorpioYearHoroscope(this);
        asyncTask.execute();
    }
    ...
    public void copyHoroscopeToClipboard() {
        TextView textView = (TextView)findViewById(R.id.tvScorpioYear);
    ...
    protected void saveCurrentHoroscope(){
        HoroscopeDatabase horoscopeDatabase = new HoroscopeDatabase(ScorpioYearActivity.this);
    ...
    private class AsyncScorpioYearHoroscope extends AsyncTask<Void,Integer,String> {
        private Context mContext;
        private ProgressDialog mProgressDialog;

        public AsyncScorpioYearHoroscope(Context context){
        ...
        private static final String TAG = "AsyncScorpioYearHoroscope";
        @Override
        protected String doInBackground(Void... voids) {
            final String url = "http://goroskop.online.ua/scorpio/year";
            String result = "";
            try {
