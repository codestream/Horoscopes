...
public class VirgoYearActivity extends BaseActivity implements HoroscopeClipboard {
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.layout_virgo_year);
        AsyncTask<Void,Integer,String> asyncTask = new AsyncVirgoYearHoroscope(this);
        asyncTask.execute();
    }
    ...
    public void copyHoroscopeToClipboard() {
        TextView textView = (TextView)findViewById(R.id.tvVirgoYear);
    ...
    protected void saveCurrentHoroscope(){
        HoroscopeDatabase horoscopeDatabase = new HoroscopeDatabase(VirgoYearActivity.this);
    ...
    private class AsyncVirgoYearHoroscope extends AsyncTask<Void,Integer,String> {
        private Context mContext;
        private ProgressDialog mProgressDialog;

        public AsyncVirgoYearHoroscope(Context context){
        ...
        private static final String TAG = "AsyncVirgoYearHoroscope";
        @Override
        protected String doInBackground(Void... voids) {
            final String url = "http://goroskop.online.ua/virgo/year";
            String result = "";
            try {
