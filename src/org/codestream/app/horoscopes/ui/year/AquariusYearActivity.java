...
public class AquariusYearActivity extends BaseActivity implements HoroscopeClipboard {
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.layout_aquarius_year);
        AsyncTask<Void,Integer,String> asyncTask = new AsyncAquariusYearHoroscope(this);
        asyncTask.execute();
    }
    ...
    public void copyHoroscopeToClipboard() {
        TextView textView = (TextView)findViewById(R.id.tvAquariusYear);
    ...
    protected void saveCurrentHoroscope(){
        HoroscopeDatabase horoscopeDatabase = new HoroscopeDatabase(AquariusYearActivity.this);
    ...
    private class AsyncAquariusYearHoroscope extends AsyncTask<Void,Integer,String> {
        private Context mContext;
        private ProgressDialog mProgressDialog;

        public AsyncAquariusYearHoroscope(Context context){
        ...
        private static final String TAG = "AsyncAquariusYearHoroscope";
        @Override
        protected String doInBackground(Void... voids) {
            final String url = "http://goroskop.online.ua/aquarius/year";
            String result = "";
            try {
